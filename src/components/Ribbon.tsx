...
const Ribbon: React.FC<RibbonProps> = ({ text, position = 'top-right' }) => {
  ...
  const positions = {
    'top-left': 'top-[2px] left-[-10px] transform -translate-x-1/2 -translate-y-1/2',
    'top-right': 'top-[5px] right-[-8px] transform translate-x-1/2 -translate-y-1/2',
    'bottom-left': 'bottom-[5px] left-[-8px] transform -translate-x-1/2 translate-y-1/2',
    'bottom-right': 'bottom-[5px] right-[-8px] transform translate-x-1/2 translate-y-1/2',
  };
